...
urlpatterns = [
    ...
    path("briefs/<str:brief_id>/source-stl", BriefSourceStlUploadView.as_view(), name="brief-source-stl"),
    path("briefs/<str:brief_id>/ratings", BriefRatingView.as_view(), name="brief-rating"),
